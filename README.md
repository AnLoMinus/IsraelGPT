...
## ✨ תכונות מרכזיות (נכון לגרסה 0.8.2)
...
*   **🤝 מצב "חברותא" (דיאלוג):** בחר שתי דמויות, הצג נושא לדיון, וצפה בהן מנהלות דיאלוג מעמיק ביניהן, מתווכחות, מביאות מקורות ומגיעות לתובנות משותפות.
