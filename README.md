...
## ✨ תכונות מרכזיות (נכון לגרסה 0.11.0)
...
*   **📜 קורות חיים לכל דמות:** לחיצה על כפתור המידע (i) ליד כל דמות מציגה כרטיסיית קורות חיים מלאה הכוללת שנות חיים, ציטוטים מפורסמים וביוגרפיה מקיפה.
*   **🏛️ בית מדרש (דיון רב-משתתפים):** בחר עד 15 דמויות, הצג נושא לדיון, וצפה בהן מנהלות דיון ער ומעמיק ביניהן, מתווכחות, מביאות מקורות ומגיעות לתובנות משותפות.
*   **👑 12 השבטים:** קטגוריה ייעודית ל-12 שבטי ישראל עם אופי, סמלים וצבעים ייחודיים לכל שבט (מבוסס על אבני החושן). כולל כפתור "בחר הכל" לדיון משותף של כל השבטים.
*   **🎨 זיהוי דוברים וצבעים:** בדיון רב-משתתפים, כל דובר מקבל בועת טקסט נפרדת עם האייקון והצבע הייחודי שלו לחוויית קריאה ברורה ומרתקת.
...
*   **v0.11.0:** "קורות חיים מלאים וממשק משופר" - השלמת ביוגרפיות לכל 38 הדמויות, החלפת מנגנון הריחוף בכפתור מידע (i) ייעודי, ושיפור תצוגת חלון קורות החיים כך שלא יסתיר את תפריט הצד.
*   **v0.10.0:** "12 השבטים ובית מדרש צבעוני" - הוספת 12 השבטים עם צבעים ייחודיים, כפתור "בחר הכל", הרחבת בית המדרש ל-15 דמויות, וצביעת בועות הדיבור לפי הדובר.
*   **v0.9.1:** "תפריט ישיבה" - הוספת תפריט נפתח חדש המרכז את "פרשת השבוע" ו"תלמוד יומי".
